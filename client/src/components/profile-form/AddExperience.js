...
const AddExperience = ({ addExperience, history }) => {
  ...
  return (
    <Fragment>
      <h1 className='large text-danger'>Add An Experience</h1>
      <p className='lead'>
        <i className='fas fa-code-branch'></i> Add your developer/programming
        experience that you have gained as you do more projects
      </p>
      ...
      >
        <div className='form-group'>
          <input
            type='text'
            placeholder='* Your Experience e.g. Bootstrap 4, web deploy'
            name='title'
            value={title}
        ...
        <div className='form-group'>
          <input
            type='text'
            placeholder='* The course that you gained the experience'
            name='company'
            value={company}
            onChange={(e) => onChange(e)}
            required
